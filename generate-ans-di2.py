...
def replace_words(sentence):
    ...
    n = len(words)
    replace_indices = random.sample(range(n), 1)
...
def generate_C2(c1, num_threads=32):
    type_0_count = len(c1)
...
# c2_type_0, c2_type_1, c2_type_2 = generate_C2(c1)
c2_type_0 = generate_C2(c1, 8)
