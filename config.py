...
def set_args():
    ...
    parser.add_argument('--pretrained_model_path', default='./output-1-bert-base-uncased/task-1-bert-base-uncased-2023-03-23_15-02-08', type=str, help='预训练模型的路径')
    parser.add_argument('--output_dir', default='./output-3-(1->3)', type=str, help='模型输出')
