...
def set_args():
    ...
    parser.add_argument('--pretrained_model_path', default='./output-2/task-2-.-output-1-task-1-bert-base-uncased-2023-03-23_15-02-08-2023-03-24_12-39-32', type=str, help='预训练模型的路径')
