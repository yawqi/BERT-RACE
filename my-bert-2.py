...
def main():
    ...
    # train_data = [
    #     ("This is a cat.", "The animal is napping.", 0),
    #     ("I love eating pizza.", "My favorite food is Italian.", 1),
    #     ("The weather is nice today.", "It's a beautiful day outside.", 2),
    #     ("She sang a beautiful song.", "The performance was amazing.", 3),
    #     ("I can't wait to travel.", "Exploring new places is so much fun.", 4),
    #     ("The movie was terrible.", "I wish I hadn't wasted my time watching it.", 5)
    # ]
